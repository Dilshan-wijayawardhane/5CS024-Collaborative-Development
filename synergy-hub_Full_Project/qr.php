...
<head>
    ...
    <meta charset="UTF-8">
    <title>QR Scanner - Synergy Hub</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div id="sidebar" class="sidebar">
    ...
    <div class="sidebar-user">
        ...
        <div class="sidebar-user-info">
            <h4>John Doe</h4>
            <p><i class="fa-solid fa-star"></i> 120 points</p>
        </div>
    </div>
    ...
    <ul class="sidebar-nav">
        ...
        <li class="sidebar-nav-item">
            <a href="qr.html" class="sidebar-nav-link active">
    ...
    <div class="sidebar-stats">
        ...
        <div class="sidebar-stat-item">
            <div class="sidebar-stat-value">120</div>
...
<header class="navbar">
    ...
    <h1 class="logo">Synergy <span>Hub</span> - QR Scanner</h1>
...
<div class="qr-container">
    ...
    <p style="color: rgba(255,255,255,0.8); margin-bottom: 30px;">
        Scan QR codes to check in to facilities, events, and more
    </p>
    ...
    <div class="scanner-box">
        ...
        <div style="margin-top: 40px;">
            <h3 style="color: white; margin-bottom: 20px;">Sample QR Codes</h3>
            <div class="sample-grid">
                <div class="sample-item" onclick="demoScan('GYM001')">
                    <i class="fa-solid fa-dumbbell"></i>
                    <p>Gym</p>
                </div>
                <div class="sample-item" onclick="demoScan('LIB001')">
                    <i class="fa-solid fa-book"></i>
                    <p>Library</p>
                </div>
                <div class="sample-item" onclick="demoScan('CAFE001')">
                    <i class="fa-solid fa-mug-saucer"></i>
                    <p>Café</p>
                </div>
                <div class="sample-item" onclick="demoScan('EVENT001')">
...
function startScanner() {
    ...
    document.querySelector('.camera-select').style.display = 'block';
...
function showResult(text) {
    document.getElementById('resultContent').innerHTML = `
        <strong>Scanned:</strong> ${text}<br>
        <strong>Type:</strong> ${getQRType(text)}<br>
    ...
    setTimeout(() => {
        ...
        points.innerText = currentPoints + 10;
...
function getQRType(text) {
    if (text.includes('GYM')) return 'Gym Facility';
    if (text.includes('LIB')) return 'Library';
    if (text.includes('CAFE')) return 'Café';
